...
//  AuthenticatorApp
//
//  Created by Danik Lubohinec on 10/03/2025.
//
...
class PurchaseService: ObservableObject {
    ...
    @Published var isFV: Bool = false
    
    let appGroupDefaults = UserDefaults(suiteName: "group.com.authenticator.assistant.app")
